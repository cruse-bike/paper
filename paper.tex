...
outline the methods used to generate the evidence presented in the tool,
including disaggregation of origin-destination data, additional trip
purposes, routing, scenarios of cycling potential, and the user
...
This describes describe the design, features and potential use of an
...
\href{https://cruse.bike/}{cruse.bike} in the CRUSE Tool for Ireland,
the landing page of which is illustrated in Figure~\ref{fig-landing}. In
...
limitations and possible future improvements to the approach, and the
implications of the results for Ireland before making concluding remarks
