...
\caption{\label{fig-trip-purposes}Everyday trip purposes used in the
CRUSE Tool.}
...
user-friendly, with the ability to generate evidence at the route level,
which is crucial for planning new cycling infrastructure. Overall, the
workshop participants concluded that the approach filled gap in evidence
and will greatly assist in the development of new cycling projects.
