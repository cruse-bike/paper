...
CRUSE is a ``great tool for getting started with project outline
documents''. It's an ``ideal tool for generating a strategic rationale
for estimating demand and building the business case in the absence of
cycle count data'' (Declan Keenan, Senior Transport Planner working on
active travel, personal communication). ``It's a good representation of
what's going on''

``I like to know that the data on the county maps is from POWSCAR data
...
{[}To be added post review.{]}
  ...
  \bibliography{bibliography.bib,cruse.bib,references.bib}
