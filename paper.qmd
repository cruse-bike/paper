...
Furthermore, highly efficient e-bikes --- which are seeing rapid uptake in Ireland and other countries --- outperform electric electric cars, which are too heavy and expensive.
Heavy electric cars could slow the transition away from car dependency and inadvertently enable "high travel lock-in" [@anable2019].
