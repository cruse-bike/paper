...
The main result of the CRUSE project is a new and open access web application and dataset on current and potential future cycling levels in Ireland, with evidence provided at county and route segment levels.
...
To illustrate the results in urban areas, we took the top 4 cities in Ireland by population: Dublin, Cork, Limerick and Galway.
The results for these cities are presented in @fig-city-results.
...
rnet_fastest = sf::read_sf("./../testout/dublin/rnet_combined_fastest.gpkg")
...
![](images/rnet_fastest_city_top.png)

Top 10,000 routes in Dublin by 'cycle friendliness' (quietness) based on the 'fastest' route network.
