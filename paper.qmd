...
This describes describe the design, features and potential use of an approach to strategic cycle network planning that is open, scalable, and evidence-based.
...
Area-based tools were developed first.
Parkin and colleagues presented a regression model to estimate the percentage of cycling trips to work in England and Wales based on socioeconomic, transportation, and physical factors at the small area (wards) level in 2007 [@parkin_estimation_2007].
