...
Uptake of cycling, the main topic of this paper, should be seen in this broader context of transport decarbonisation [@brand2020].
...
At the European level, the European Union has set a target of reducing greenhouse gas emissions by 55% by 2030, compared to 1990 levels, and to achieve 'net-zero' by 2050.[^1]
...
Specifically, "Member States shall ensure that the ranking of high accident concentration sections and the network safety ranking are carried out".
[^2] Given that 'safety' in this context is usefully quantified as the number of people killed and seriously injured (KSI) per distance travelled, the directive requires estimation of distance travelled by mode, down to the road link level
. For cycling, on which there is a paucity of data, this is a major challenge
.

[^1]: https://climateactiontracker.org/countries/eu/targets/
...
[^3]: https://www.drugsandalcohol.ie/35347/
...
The PCT approach has had major policy impacts, as outlined in Research Excellence Framework (REF) impact case studies submitted by the University of Leeds and the University of Westminster, which demonstrate that the tool "revolutionised strategic cycle planning in England and Wales"[^4] by overcoming the barriers to cycling investment imposed by lack of evidence on cycling potential[^5]
.
...
The 'biclaR' project included estimation of impacts, using the World Health Organisation (WHO) 'HEAT for Cycling' tool[^6].
