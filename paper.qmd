...
This provision of multiple scenarios of behaviour change *and* multiple scenarios of investment, for example in cycling infrastructure next to major roads vs quiet residential streets, is a key feature of the CRUSE Tool.
...
Because the results are available at the route segment level, the tool can be used to identify 'weak links' in the cycle network, and to prioritize investment in cycling infrastructure.
