...
Cars are a major and growing source of greenhouse gas emissions causing climate change [@winkler2023], a leading cause of premature death and injury due to road traffic collisions [@globals2018] , and a cause of disease due to physical inactivity and air, noise and (from tyres) microplastic pollution [@mattsson2023] [@welch2023] [@cavallaro2024].
Transport is responsible for 23% of global greenhouse gas (GHG) emissions, 70% of which are from road transport, with passenger cars accounting for nearly half of transport emissions (around 10% of global emissions) [@jaramillo2022].
...
Furthermore, highly efficient ebikes --- which are seeing rapid uptake in Ireland and other countries --- outperform electric cars, which are too heavy and expensive.
...
7 in 10 trips in Ireland are by car [@national] .
...
We label the approach Cycle Route Uptake and Scenario Estimation (CRUSE) and present a case study of its application in Ireland, the results of which are publicly available at [cruse.bike](https://cruse.bike/) in the CRUSE Tool for Ireland, the landing page of which is illustrated in @fig-landing.
...
# Tools for estimating cycling potential
...
The Climate Action Plan scenario models the transport emissions reductions targeted in the Irish Government's [Climate Action Plan 2021](https://www.gov.ie/en/publication/6223e-climate-action-plan-2021/), which aims for a 51% cut in overall greenhouse gas emissions by 2030 as part of the pathway to net-zero emissions by 2050.
