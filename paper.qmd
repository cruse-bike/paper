...
- Calculation of hundreds-of-thousands of routes, which is against the terms of service of the free API.
- Making changes to the routing profiles, including allowing routing on trunk roads, which are not permitted in the default routing profiles.
