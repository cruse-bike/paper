...
::: {#fig-route-types layout-nrow="2"}
![](images/naas_quietest.png){width="250"}

![](images/naas_fastest.png){width="250"}

<!-- ![](images/newbridge_quietest.png){width="250"} -->

<!-- ![](images/newbridge_fastest.png){width="250"} -->

Illustration of the Quietest (top) and Fastest (bottom) route networks for Naas.
:::
