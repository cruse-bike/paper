...
%DIF DEL paper-v1.tex   Fri Mar 22 15:52:20 2024
%DIF ADD paper.tex      Sat Mar 23 13:07:02 2024
...
%DIFDELCMD < %%%
\DIFdel{This paper describes the design, features and potential use of the }\DIFdelend \DIFaddbegin \DIFadd{This paper describes an approach to the development of strategic cycle
network planning tools. Based on our experience developing and deploying
the }\DIFaddend Cycle Route Uptake and Scenario Estimation (CRUSE) Tool for Ireland\DIFdelbegin \DIFdel{was
...
%DIFDELCMD < %%%
\DIFdel{For investment in cycling to
deliver on the huge potential benefits,
cycling must become safer. With growth in the ebike market, CRUSE will
help inform inter-urban and rural networks to support the transfer of trips to sustainable modes for longer journeys. Provision of open access
...
with sustainable transport policies worldwide}\DIFdelend \DIFaddbegin \DIFadd{and `Quietest' to help plan both
...
\DIFdelbegin \DIFdel{High energy transport systems are a major contributor to climate change
}\DIFdelend \DIFaddbegin \DIFadd{Transport systems dominated by heavy and powerful private cars are
...
\citep{mattsson2023} }\hskip0pt%DIFAUXCMD
\mbox{%DIFAUXCMD
...
systems has led }\DIFaddend governments in many countries \DIFdelbegin \DIFdel{have }\DIFdelend \DIFaddbegin \DIFadd{to }\DIFaddend set targets and taken
...
levels of geographic resolution \mbox{%DIFAUXCMD
...
identified \DIFdelbegin \DIFdel{and improved. A proactive approach to the }\DIFdelend \DIFaddbegin \DIFadd{`cycle proofed'. Cycling in Ireland represents only 3\% of
total modal share as of the 2016 Census, but accounts for 20\% of
serious injuries and 7\% of all fatalities, driving the }\DIFaddend development of
cycling policy and infrastructure \DIFdelbegin \DIFdel{is taking place }\DIFdelend \DIFaddbegin \DIFadd{plans }\DIFaddend in Ireland. The main frameworks
...
\DIFaddbegin \DIFadd{of high support for and capability for cycling}\DIFaddend : ``nearly a quarter of
...
This \DIFdelbegin \DIFdel{paper aims to }\DIFdelend \DIFaddbegin \DIFadd{describes }\DIFaddend describe the design, features and potential use of \DIFdelbegin \DIFdel{the CRUSE Tool}\DIFdelend \DIFaddbegin \DIFadd{an
approach to strategic cycle network planning that is open, scalable, and
evidence-based. We label the approach Cycle Route Uptake and Scenario
Estimation (CRUSE) and present a case study of its application in
Ireland, the results of which are publicly available at
}\href{https://cruse.bike/}{\DIFadd{cruse.bike}} \DIFadd{in the CRUSE Tool for Ireland,
the landing page of which is illustrated in Figure~\ref{fig-landing}}\DIFaddend . In
Section~\ref{sec-methods}, we outline the methods used to generate the
evidence presented in the CRUSE Tool. In Section~\ref{sec-results}, we
present the results of the CRUSE Tool, including estimates of current
cycling levels and future cycling potential at the national, regional
and local levels. In Section~\ref{sec-discussion}, we discuss
\DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{limitations and possible future improvements to the approach, and the
}\DIFaddend implications of the results for \DIFdelbegin \DIFdel{policy and practice. In }\DIFdelend \DIFaddbegin \DIFadd{Ireland before making concluding remarks
in }\DIFaddend Section~\ref{sec-conclusions}\DIFdelbegin \DIFdel{, we conclude
the paper}\DIFdelend .
...
build on the }\DIFdelend \DIFaddbegin \DIFadd{Tools for estimating geographical distribution of cycling potential have
...
\DIFadd{Analysis of  Cycling Potential (ACP), Transport for London (2010, 2016) }& \DIFadd{London, London Travel Demand Survey }& \DIFadd{Static tables, graphs, and heatmaps, not publicly available }& \DIFadd{Proprietary}\\
...
\addlinespace
\DIFaddend Propensity to Cycle Tool (PCT), \DIFdelbegin \DIFdel{which was originally funded
by the UK's Department for Transport and developed by a multi-university
team. An important feature of the PCT is that it is open source and publicly available (at }\href{https://www.pct.bike/}{\DIFdel{www.pct.bike}}%DIFAUXCMD
\DIFdel{) ,
...
planning in }\DIFdelend \DIFaddbegin \DIFadd{Lovelace et al. (2017) }& \DIFaddend England and \DIFdelbegin \DIFdel{Wales'' by overcoming the barriers }\DIFdelend \DIFaddbegin \DIFadd{Wales, Journeys to work and school OD census data, at the small area (LSOA) level }& \DIFadd{Online maps, graphs, tables, publicly available at www.pct.bike }& \DIFadd{Open source}\\
...
\DIFadd{Area-based tools were developed first. Parkin and colleagues presented a
...
\citet{lovelace2017}}\hskip0pt%DIFAUXCMD
...
\DIFaddbegin \DIFadd{A limitation of the approach as implemented in the CRUSE tool is that
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibliography{bibliography.bib,cruse.bib}
\DIFaddend 
